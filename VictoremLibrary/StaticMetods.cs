...
namespace VictoremLibrary
{
    public static class StaticMetods
    {
        ...
        private static ShaderResourceView CreateTextureFromDDS(SharpDX.Direct3D11.Device device, SharpDX.Direct3D11.DeviceContext context, byte[] data, out bool isCubeMap)
        {
        ...
        private static ShaderResourceView InitTextureFromData(SharpDX.Direct3D11.Device d3dDevice, SharpDX.Direct3D11.DeviceContext context, DDS_HEADER header, DDS_HEADER_DXT10? header10, byte[] bitData, int offset, int maxsize, out bool isCubeMap)
        {
